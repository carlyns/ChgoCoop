...
<div class="container archive">
	...
	$args['post_type'] = array('post'); // can delete articles from the array and it'll still work.  this is leftover from the copied code cuz somone had a CPT of 'articles'
	query_posts( $args );
